...
int Crypto::ECDH::ecdh_generate_keys(uint8_t* public_key, uint8_t* private_key)
{
...
int Crypto::ECDH::ecdh_shared_secret(const uint8_t* private_key, const uint8_t* others_pub, uint8_t* output)
{
